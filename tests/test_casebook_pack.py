"""Regression checks for the riskledger casebook."""
...
from casebook.harness import assert_expected, riskledger_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(riskledger_summary(), assert_expected())
