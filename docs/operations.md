...
`riskledger` is centered on databases work in SQL. The technical target is: Analyze exposure buckets and settlement reconciliation.
...
The score is deterministic. The current threshold is 155. Risk has a penalty of 4, latency has a penalty of 4, and weight contributes a bonus of 4.
